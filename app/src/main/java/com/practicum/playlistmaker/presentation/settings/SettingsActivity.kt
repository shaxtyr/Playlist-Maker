...
class SettingsActivity: AppCompatActivity() {
    ...
    private lateinit var themeRepository: ThemeLocalRepository
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        themeRepository = Creator.getThemeLocalRepository()
        ...
        themeSwitcher.isChecked = themeRepository.getTheme()
